...
int main(int argc, char **argv)
{
    ...
    BM3D::BM3D_Initialize(img, imgOrig, width, height, step, (3 * distanceHTThreshold * 64), (distanceWienThreshold * 64), (sigma * HTThreshold), sigma, windowSize, stepInWindow, false);  
