...
__global__ void BlockMatching2(int* distanceArray, int* blockMap, float* dctBlocks, int blockPerLine, int blockSize, int* pixelMap, int nHard, int width)
{
...
void BM3D::BM3D_BlockMatching2()
{
    ...
    BlockMatching2<<<numBlocks,threadsPerBlock>>>(BM3D::context.distanceArray, BM3D::context.blockIndexMapping, BM3D::context.dctBlocks, BM3D::context.nbBlocksPerLine, (BM3D::context.nHard * BM3D::context.nHard), BM3D::context.pixelMap, BM3D::context.nHard, BM3D::context.img_width);
    cudaThreadSynchronize ();
...
void BM3D::BM3D_CreateBlockMap()
{
    ...
    cudaThreadSynchronize ();     
    CreateBlocks_Zone<<<numBlocks,threadsPerBlock>>>( BM3D::context.blockIndexMapping, BM3D::context.deviceImage, index, indexBlock, (BM3D::context.img_width - 1), 0, -1, 1, BM3D::context.blocks, BM3D::context.nHard, BM3D::context.img_width, BM3D::context.pixelMap);
    cudaThreadSynchronize (); 
    CreateBlocks_Zone<<<numBlocks,threadsPerBlock>>>( BM3D::context.blockIndexMapping, BM3D::context.deviceImage, (index * 2), (indexBlock * 2), 0, (BM3D::context.img_height -1 ), 1, -1, BM3D::context.blocks, BM3D::context.nHard, BM3D::context.img_width, BM3D::context.pixelMap);
    cudaThreadSynchronize (); 
    CreateBlocks_Zone<<<numBlocks,threadsPerBlock>>>( BM3D::context.blockIndexMapping, BM3D::context.deviceImage, (index * 3), (indexBlock * 3), (BM3D::context.img_width-1), (BM3D::context.img_height-1), -1, -1, BM3D::context.blocks, BM3D::context.nHard, BM3D::context.img_width, BM3D::context.pixelMap);
    cudaThreadSynchronize ();  
}
